$(function(){
    ...
    var base_url='http://localhost/capstone/index.php/'; // Here i define the base_url
    ...
    function validator(elements) {
        ...
        if(errors) {
            $('.errorsss').html('<div class="alert alert-warning alert-dismissible" role="alert">'+
                  '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>Please insert Title and Description</div>');   
            return false;
        }
        return true;
    }
